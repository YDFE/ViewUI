...
describe('Select.vue', () => {
  ...
  describe('Props tests', () => {
    it('should create a Select component with passed placeholder', done => {
      ...
      vm.$nextTick(() => {
        const placeholderSpan = vm.$el.querySelector('.ivu4-select-placeholder');
    ...
    it('should create a Select component and take a pre-selected value', done => {
      ...
      waitForIt(
          () => {
              const selectedValueSpan = vm.$el.querySelector('.ivu4-select-selected-value');
    ...
    it('should display normal characters in input when in filterable mode', done => {
      ...
      vm.$nextTick(() => {
        const input = vm.$el.querySelector('.ivu4-select-input');
    ...
    it('should set different classes for different sizes', done => {
	  ...
	  `);
      vm.$nextTick(() => {
        const [defaultSelect, largeSelect, smallSelect] = [...vm.$el.querySelectorAll('.ivu4-select')];
        expect(defaultSelect.className).to.equal('ivu4-select ivu4-select-single ivu4-select-default');
        expect(largeSelect.classList.contains('ivu4-select-large')).to.equal(true);
        expect(smallSelect.classList.contains('ivu4-select-small')).to.equal(true);
        done();
      });
    });
    ...
    it('should set new options', done => {
      ...
      const callback = function() {
        const renderedOptions = vm.$el.querySelectorAll('.ivu4-select-dropdown-list li');
  ...
  describe('Behavior tests', () => {
    ...
    `,
          ...
          new Promise(resolve => {
              const condition = function() {
                  const optionsA = SelectA.$el.querySelectorAll('.ivu4-select-item');
                  const optionsB = SelectB.$el.querySelectorAll('.ivu4-select-item');
              ...
              .then(() => {
                  ...
                  const getSelections = component => {
                      const tags = component.$el.querySelectorAll('.ivu4-select-selection .ivu4-tag');
  ...
  describe('Public API', () => {
      it('The "setQuery" method should behave as expected', (done) => {
          ...
          vm.$nextTick(() => {
              ...
              const renderedOptions = [...vm.$el.querySelectorAll('.ivu4-select-item')].map(el => el.textContent);
